                ...
                <Paper  sx={{p:4}}>
                    <Stack direction={'column'} spacing={4}>
                        ...
                        <Stack direction={'column'} spacing={1}>
                            <Grid container sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                ...
                                <BtContentGrid gridXs={6} title={'법인등기사항전부증명서'} >
                                    <Stack direction={'row'} alignItems={"center"} spacing={2} sx={{width:'100%'}}>
                                        <Typography flexGrow={1} sx={{color:theme.palette.primary.main , textDecoration:'underline'}}> 
                                            법인등기사항전부증명서_(주)홈핏.pdf
                                        </Typography>
                                    </Stack>
                                </BtContentGrid>
                            ...
                            <Grid container sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                ...
                                <BtContentGrid gridXs={6} title={'설립년월일'} >
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <DatePicker  disabled format="YYYY-MM-DD" value={dayjs('2017-01-25')} sx={{
                                            width:'100%',backgroundColor:theme.palette.disabled.lighter}}
                        ...
                        <Stack direction={'row'} spacing={1} justifyContent="center" alignItems="center">
                            <Button size="large" variant="outlined" disableElevation>목록</Button>
                            <Button size="large" variant="outlined" disableElevation>대출신청 취소</Button>
                            <Button size="large" variant="contained" disableElevation>수정</Button>
                        </Stack>
                    </Stack>
                </Paper>
            </Stack>
