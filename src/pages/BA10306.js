                    ...
                    <Stack direction={'column'} spacing={4}>
                            ...
                            <Grid container sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                ...
                                <BtContentGrid gridXs={6} title={'기준수익률(IRR)'} required={true}>
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <DatePicker format="YYYY-MM-DD" disabled sx={{width:'100%', backgroundColor:theme.palette.disabled.lighter}}/>
                                        ...
                                        <Table size="small" sx={{ minWidth: 650 }} aria-label="simple table">
                                            ...
                                            <TableBody>
                                                <TableRow>
                                                    ...
                                                    <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <TextField size="small" value={''} sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} /> 
                                                    </TableCell>
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <TextField size="small" value={''} sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} /> 
                                                    </TableCell>
                        ...
                        <Stack direction={'column'} >
                            <Stack direction={'row'}>
                                <Grid container sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                    ...
                                    <BtContentGrid gridXs={12} title={'운용규모'} >
                                        <Stack direction={'row'} spacing={2} >
                                            <TextField size="small" value={''} InputProps={{ endAdornment: <InputAdornment position="end">개 펀드</InputAdornment>,}} disabled sx={{width:'12rem', boxSizing:'border-box',backgroundColor:theme.palette.disabled.lighter }} />
                                            <TextField size="small" value={''} InputProps={{ endAdornment: <InputAdornment position="end">억원</InputAdornment>,}} disabled sx={{width:'12rem',backgroundColor:theme.palette.disabled.lighter}} />
                                        </Stack>
                            ...
                            <BtContentGrid gridXs={12} title={'펀드 소진율'}>
                                <TextField size="small" value={''} placeholder="(활동 펀드. 중 최저 소진율 펀드) 펀드명/ 결성금액/ 투자금액" disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} />
                            </BtContentGrid>
                        </Stack>
                        ...
                        <Stack direction={'column'} spacing={1}>
                            <Grid container sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                ...
                                <BtContentGrid gridXs={6} title={'총 운용인력 수'} required={true}>
                                    <TextField size="small" value={''} InputProps={{ endAdornment: <InputAdornment position="end">명</InputAdornment>}} disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} />
                                </BtContentGrid>
                                                    ...
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <Stack direction={'row'} spacing={2}>
                                                            <Stack direction={'row'} alignItems="center">
                                                                ...
                                                                <TextField size="small" value={''} disabled sx={{width:'5rem',backgroundColor:theme.palette.disabled.lighter}} />
                                                            </Stack>
                                                            <Stack direction={'row'} alignItems="center">
                                    ...
                                    <Stack direction={'column'} spacing={2} sx={{width:'100%'}}>
                                        <Box sx={{p:2, boxSizing:'border-box', width:'100%',  backgroundColor:theme.palette.background.default}}>
                                            <Stack direction="column"  justifyContent="flex-start" alignItems="flex-start" sx={{ p:2  }}>
                                                ...
                                                <Typography>파일명.pptx</Typography>
                                            </Stack>
                                        </Box>
