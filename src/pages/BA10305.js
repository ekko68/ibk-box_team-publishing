                ...
                <Paper  sx={{p:4}}>
                    <Stack direction={'column'} spacing={4}>
                        ...
                        <Stack direction={'column'} spacing={1}>
                            <Grid container sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                ...
                                <BtContentGrid gridXs={6} title={'펀드유형'} required={true}>
                                    ...
                                    <BtSelect defaultValue={0} disabled={true}>
                                            ...
                                            <TableBody>
                                                <TableRow>
                                                    <TableCell align="center" component="th" scope="row">
                                                        <TextField size="small" value={'한국모태펀드'} disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} />
                                                    </TableCell>
                                                    <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <TextField size="small" value={'22년 정시 1차 창업초기 루키'} disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} /> 
                                                    </TableCell>
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <TextField size="small" disabled InputProps={{endAdornment: <InputAdornment position="end">억원</InputAdornment>}} value={'999'} sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} /> 
                                                    </TableCell>
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <BtSelect defaultValue={1} disabled={true}>
                                                            <MenuItem disabled value={0}>선택하세요</MenuItem>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <BtSelect defaultValue={2} disabled={true}>
                                                            <MenuItem disabled value={0}>선택하세요</MenuItem>
                                                            <MenuItem value={1}>선정</MenuItem>
                                                            <MenuItem value={2}>서류 통과</MenuItem>
                                                            <MenuItem value={3}>서류 심사 중</MenuItem>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <TextField size="small" InputProps={{endAdornment: <InputAdornment position="end">억원</InputAdornment>}} disabled value={'999'} sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} /> 
                                                    </TableCell>
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <BtSelect defaultValue={3} disabled={true}>
                                                            <MenuItem disabled value={0}>선택하세요</MenuItem>
                                                            <MenuItem value={1}>선정</MenuItem>
                                                            <MenuItem value={2}>서류 통과</MenuItem>
                                                            <MenuItem value={3}>서류 심사 중</MenuItem>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <BtSelect defaultValue={4} disabled={true}>
                                                            <MenuItem disabled value={0}>선택하세요</MenuItem>
                                                            <MenuItem value={1}>선정</MenuItem>
                                                            <MenuItem value={2}>서류 통과</MenuItem>
                                                            <MenuItem value={3}>서류 심사 중</MenuItem>
                                    ...
                                    <TableContainer component={Paper} sx={{borderRadius:0, boxShadow:'none'}}>
                                        <Table size="small" sx={{ minWidth: 650 }} aria-label="simple table">
                                            ...
                                            <TableBody>
                                                <TableRow>
                                                    <TableCell align="center" component="th" scope="row">
                                                        <TextField size="small" value={''} disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}} />
                                                    </TableCell>
                                                    <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <FormControl>
                                                            <RadioGroup row>
                                                                <FormControlLabel value="1" control={<Radio/>} label={<TextField size="small" value={''} InputProps={{endAdornment: <InputAdornment position="end">억원</InputAdornment>}} disabled sx={{width:'6rem',backgroundColor:theme.palette.disabled.lighter}} />} />
                                                    ...
                                                    <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <FormControl>
                                                            <RadioGroup row>
                                                                <FormControlLabel value="1" control={<Radio/>} label={<TextField size="small" value={''} InputProps={{endAdornment: <InputAdornment position="end">%</InputAdornment>}} disabled sx={{width:'6rem',backgroundColor:theme.palette.disabled.lighter}} />} />
                                                                <FormControlLabel value="2" control={<Radio/>} label="미정" />
                                                            </RadioGroup>
                                                        </FormControl>
                                                    </TableCell>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        ...
                                                        <TextField size="small" value={''} InputProps={{endAdornment: <InputAdornment position="end">억원</InputAdornment>}} disabled sx={{width:'10rem', backgroundColor:theme.palette.disabled.lighter}} />
                                                    
                                                    
                                                    </TableCell>
                                                    <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                                        <TextField size="small" value={''} InputProps={{endAdornment: <InputAdornment position="end">%</InputAdornment>}} disabled sx={{width:'10rem',backgroundColor:theme.palette.disabled.lighter}} />
                                                    </TableCell>
                                                    <TableCell align="left" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                        ...
                        <Stack direction={'row'} spacing={1} justifyContent="center" alignItems="center">
                            <Button size="large" variant="outlined" disableElevation>제안 취소</Button>
                            <Button size="large" variant="contained" disableElevation>다음</Button>
                        </Stack>
                    </Stack>
                </Paper>
            </Stack>
