                            ...
                            <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
                                <TableHead sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                    <TableRow>
                                        ...
                                        <TableCell align="center" sx={{borderLeft:`1px solid ${theme.palette.divider}`, color: theme.palette.text.sub}}>주요사업</TableCell>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>빅데이터 기반 상품 추천 서비스
                                        </TableCell>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>123-12-12345
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>빅데이터 기반 상품 추천 서비스
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Chip  label="추천 취소" sx={{borderRadius:1, width:'10rem', backgroundColor:theme.palette.error.light, color:theme.palette.text.contrastText}}/>
                                        </TableCell>
