            ...
            <Container maxWidth="false" disableGutters sx={{maxWidth:'1280px', px:'1.25rem'}}>
                <Box>
                    <Stack direction={'row'} divider={<Divider orientation="vertical" flexItem />}>
                        ...
                        <BtNavSelect  defaultValue={10} >
                            <MenuItem value={10} sx={{fontSize:'1rem'}}>추천기업 상세</MenuItem>
                            <MenuItem value={20} sx={{fontSize:'1rem'}}>Item 2</MenuItem>
                            <MenuItem value={30} sx={{fontSize:'1rem'}}>Item 3</MenuItem>
                        </BtNavSelect>
                        <Divider orientation="vertical" flexItem sx={{height:'1px'}}/>
                ...
                <Paper  sx={{p:4}}>
                    <Stack direction={'column'} spacing={4}>
                                ...
                                <BtContentGrid gridXs={12} title={'리드투자자'} >
                                    <Stack direction={'row'} spacing={2} sx={{width:'100%'}}>
                                        <Stack flexGrow={1} direction={'row'} alignItems={'center'} spacing={1}>
                                            ...
                                            <TextField flexGrow={1} size="small" value={''} disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}}/>  
                                        </Stack>
                                        <Stack flexGrow={1} direction={'row'} alignItems={'center'} spacing={1}>
                                        ...
                                        <Stack flexGrow={1} direction={'row'} alignItems={'center'} spacing={1} >
                                            ...
                                            <BtSelect flexGrow={1} defaultValue={2} disabled sx={{width:'100%',backgroundColor:theme.palette.disabled.lighter}}>
                                        ...
                                        <RadioGroup row>
                                            ...
                                            label={
                                                <Stack alignItems={'center'} direction={'row'} spacing={2}>
                                                    <TextField size="small"  InputProps={{endAdornment: <InputAdornment position="end">억원</InputAdornment>}} value={''} disabled sx={{width:'100%', backgroundColor:theme.palette.disabled.lighter}} /> 
                        ...
                        <Stack direction={'row'} spacing={1} justifyContent="center" alignItems="center">
                            <Button size="large" variant="outlined" disableElevation>추천 취소</Button>
