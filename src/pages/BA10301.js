                        ...
                        <TableContainer component={Paper} sx={{borderRadius:0, boxShadow:'none'}}>
                            <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
                                <TableHead sx={{borderTop:`1px solid ${theme.palette.divider}`}}>
                                    <TableRow>
                                        <TableCell align="center" sx={{color: theme.palette.text.sub}}>작성일</TableCell>
                                        <TableCell align="center" sx={{borderLeft:`1px solid ${theme.palette.divider}`, color: theme.palette.text.sub}}>펀드명</TableCell>
                                        <TableCell align="center" sx={{borderLeft:`1px solid ${theme.palette.divider}`, color: theme.palette.text.sub}}>펀드유형</TableCell>
                                        <TableCell align="center" sx={{borderLeft:`1px solid ${theme.palette.divider}`, color: theme.palette.text.sub}}>결성목표액(원)</TableCell>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>에코그린펀드3
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>벤처투자조합
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>9,999,999,999
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Chip  label="작성중" sx={{borderRadius:1, width:'10rem', backgroundColor:theme.palette.inProgress.main, color:theme.palette.text.contrastText}}/>
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small" variant="outlined" sx={{width:'100%'}}>계속작성</Button>
                                        </TableCell>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Chip  label="제안 취소" sx={{borderRadius:1, width:'10rem', backgroundColor:theme.palette.error.light, color:theme.palette.text.contrastText}}/>
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small"  variant="outlined" sx={{width:'100%'}}>계속작성</Button>
                                        </TableCell>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Chip  label="심사 완료 - 수락" sx={{borderRadius:1, width:'10rem', backgroundColor:theme.palette.info.main, color:theme.palette.text.contrastText}}/>
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small" variant="outlined" sx={{width:'100%'}}>계속작성</Button>
                                        </TableCell>
                                    ...
                                    <TableRow sx={{backgroundColor:theme.palette.background.tableOddRow}}>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Chip  label="심사 완료 - 거절" sx={{borderRadius:1, width:'10rem', backgroundColor:theme.palette.info.main, color:theme.palette.text.contrastText}}/>
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small" variant="outlined" sx={{width:'100%'}}>계속작성</Button>
                                        </TableCell>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Chip  label="심사 완료 - 보류" sx={{borderRadius:1, width:'10rem', backgroundColor:theme.palette.info.main, color:theme.palette.text.contrastText}}/>
                                        </TableCell>
                                        <TableCell align="center" component="th" scope="row" sx={{borderLeft:`1px solid ${theme.palette.divider}`}}>
                                            <Button color="primary" size="small" variant="outlined" sx={{width:'100%'}}>계속작성</Button>
                                        </TableCell>
